            ...
            <div className="col-xl-5">
              ...
              <div className="cont campaign01">
                ...
                <p className="mt-4 mb-3">
                  In sed purus rhoncus, porta ex sit amet, interdum nisl. Phasellus vel suscipit orci. Quisque in molestie metus. Interdum et malesuada fames ac
                  ante ipsum primis in faucibus. Ut finibus bibendum est, id porta tellus.
                </p>
              ...
              <div className="cont configuration schedule">
                ...
                <div className="right-section">
                  <div className="form-group">
                    <span className="fw-500 text-lightblue mr-4">Start Date</span>
                    <input type="text" className="form-control input-date text-center form-lightblue d-inline" value="10/15/17" />
                  </div>
                  <div className="form-group">
                    <span className="fw-500 text-lightblue mr-4 pr-2">End Date</span>
                    <input type="text" className="form-control input-date text-center form-lightblue d-inline" value="10/15/17" />
                  </div>
                  <div className="schedule-elements">
                    <div className="d-flex mb-2">
                      <div className="day sr-1 mr-4">S</div>
                      <div className="fw-500 time-slot start-time-1" />
                      <div className="slider-range slider-range-1 mx-3 my-2" />
                      <div className="fw-500 time-slot end-time-1" />
                    </div>
                    <div className="d-flex mb-2">
                      <div className="day sr-2 mr-4">M</div>
                      <div className="fw-500 time-slot start-time-2" />
                      <div className="slider-range slider-range-2 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-2" />
                    </div>
                    <div className="d-flex mb-2">
                      <div className="day sr-3 mr-4">T</div>
                      <div className="fw-500 time-slot start-time-3" />
                      <div className="slider-range slider-range-3 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-3" />
                    </div>
                    <div className="d-flex mb-2">
                      <div className="day sr-4 mr-4">W</div>
                      <div className="fw-500 time-slot start-time-4" />
                      <div className="slider-range slider-range-4 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-4" />
                    </div>
                    <div className="d-flex mb-2">
                      <div className="day sr-5 mr-4">T</div>
                      <div className="fw-500 time-slot start-time-5" />
                      <div className="slider-range slider-range-5 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-5" />
                    </div>
                    <div className="d-flex mb-2">
                      <div className="day sr-6 mr-4">F</div>
                      <div className="fw-500 time-slot start-time-6" />
                      <div className="slider-range slider-range-6 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-6" />
                    </div>
                    <div className="d-flex">
                      <div className="day sr-7 mr-4">S</div>
                      <div className="fw-500 time-slot start-time-7" />
                      <div className="slider-range slider-range-7 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-7" />
                    </div>
                    ...
                    <div className="d-flex ml-3 mt-3 mb-2 pl-1">
                      ...
                      <div className="fw-500 time-slot start-time-8" />
                      <div className="slider-range slider-range-8 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-8" />
                    </div>
                    <div className="ml-5 pl-1">
                    ...
                    <div className="d-flex ml-3 mt-3 mb-4 pl-1">
                      ...
                      <div className="fw-500 time-slot start-time-9" />
                      <div className="slider-range slider-range-9 mx-3 mt-2" />
                      <div className="fw-500 time-slot end-time-9" />
                    </div>
                    <div className="ml-3">
...
export default connect(null, {})(CurrentCampaign);
