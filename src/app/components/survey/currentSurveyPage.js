  ...
  addQuestion = () => {
    ...
    */
    ...
    return fetch('https://mirth-service.staging.agentacloud.com:8877/question', {
      ...
      var source = document.getElementById('source' + this.state.questionId) 
      source.src = question.Media.mediaLocation 
      var audio = document.getElementById(this.state.questionId); audio.load();
      this.initialize()
    })
      .catch((error) => {
        console.error('survey api error --:', error); });
        ...
        var questionList = []
          if (this.state.allQuestions != null) {
            ...
            for (let i = 0; i < this.state.allQuestions.length; i++) {
              if (this.state.allQuestions[i].Media == null) 
                continue
                  ...
                  <div className="cont">
                    ...
                    <div className="row">
                      <div className="col-sm-6 col-md-7 pr-sm-0">
                        ...
                        <p className="audio-name mb-1">{question.Media==null?'Press Setting Button to Add Audio':this.extractFileName(question.Media[0].mediaLocation)}</p>
                        <div className="row">
                          <div className="col-sm-9">
                            <audio id={i} controls>
                              <source
                                id={'source' + i}
                                src={question.Media==null?null:question.Media[0].mediaLocation}
                                type="audio/wav"/>
            ...
            return (
              <section className="left-section">
                ...
                <div className="wrapper survey">
                  ...
                  {introItem != null && <div className="row">
                    <div className="col-sm-6">
                      <div className="intro-outro">
                        <h4>{introItem.description}</h4>
                        {introItem.Media != null && <div className="cont">
                          <h6 className="mb-1">AUDIO - DEFAULT</h6>
                          <p className="audio-name mb-1">{introItem.Media==null?'Press Setting Button to Add Audio':this.extractFileName(introItem.Media[0].mediaLocation)}</p>
                          <div className="row">
                            <div className="col-sm-9">
                              <audio id={introIndex} controls>
                                <source
                                  id={'source' + introIndex}
                                  src={introItem.Media==null?null:introItem.Media[0].mediaLocation}
                                  type="audio/wav"/>
                                Your browser does not support the audio element.
                              </audio>
                            </div>
                    ...
                    <div className="col-sm-6">
                      <div className="intro-outro">
                        ...
                        <div className="cont">
                          ...
                          {closingItem.Media != null && <p className="audio-name mb-1">{closingItem.Media==null?'Press Setting Button to Add Audio':this.extractFileName(closingItem.Media[0].mediaLocation)}</p>}
                          {closingItem.Media != null && <div className="row">
                            <div className="col-sm-9">
                              <audio id={closingIndex} controls>
                                <source
                                  id={'source' + closingIndex}
                                  src={closingItem.Media==null?null:closingItem.Media[0].mediaLocation}
                                  type="audio/wav"/>
                                Your browser does not support the audio element.
                              </audio>
                            </div>
                        ...
                        <div className="col-sm-4 col-md-3">
                          <div className="preview-file">
                            <audio
                              ...
                              <source
                                id='previewSource'
                                src={this.state.allQuestions != null && this.state.allQuestions[this.state.selectedQuestion].Media.mediaLocation}/>
                              Your browser does not support the audio element.
                            </audio>
