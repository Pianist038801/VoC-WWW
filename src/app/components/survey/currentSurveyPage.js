...
console.log('newReq = ', JSON.stringify(currentSurvey))
    ...
    // }).then((response) => {
    //   console.log('SAVE RESPONSE', response)
    //   // load audio var source = document.getElementById('source' +
    //   // this.state.questionId) source.src = question.Media.mediaLocation var audio =
                    ...
                    <div className="row">
                      <div className="col-sm-9">
                        <audio id={i} controls>
                          <source
                            id={'source' + i}
                            src={question.Media[0].mediaLocation}
                            type="audio/wav"/>
                        ...
                        <div className="col-sm-9">
                          <audio id={introIndex} controls>
                            <source
                              ...
                              src={introItem.Media[0].mediaLocation}
                              type="audio/wav"/>
                            Your browser does not support the audio element.
                          </audio>
                        </div>
                        ...
                        <div className="col-sm-9">
                          <audio id={closingIndex} controls>
                            <source
                              ...
                              src={closingItem.Media[0].mediaLocation}
                              type="audio/wav"/>
                            Your browser does not support the audio element.
                          </audio>
                        </div>
